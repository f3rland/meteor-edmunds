...
Edmunds = {
  ...
  selectListIds: ["#edmunds-yearsList", "#edmunds-makesList", "#edmunds-modelsList", "#edmunds-trimList"],
  APICalls: [
    function() {
  ...
  callEdmunds: function(apiPath, parseFunction, view) {
    // Instantiate the SDK
    var res;
